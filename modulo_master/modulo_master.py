...
class modulo_master_ficha(osv.osv):
  ...
  _columns = {
   ...
   #En la vista, el campo mostrará la etiqueta 'Empresa TFM',
   # dejando ver un combo con los name de las empresas registradas en la 
   # tabla modulo_master_ficha, pero éste campo debe tener un campo relacionado
   # en dicha tabla modulo_master_ficha para que se encadene la relación.
